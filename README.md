        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="card col-12 col-md-6 col-lg-3">
                        <img class="card-img-top" src="/static/img/grapes.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-3">
                        <img class="card-img-top" src="/static/img/dragon.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">dragon FRIUT</h5>
                    ...
                    <div class="card col-12 col-md-6 col-lg-3">
                        <img class="card-img-top" src="/static/img/strawberry.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="card col-12 col-md-6 col-lg-3">
                        <img class="card-img-top" src="/static/img/pomegranate.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">PINEAPPLE</h5>
                    ...
                    <div class="card col-12 col-md-6 col-lg-3">
                        <img class="card-img-top" src="/static/img/watermelon.jpg" alt="Card image cap">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12" style="background-color: lightcoral;">
                    Copyright © 2020 STARC FRUIT GALLERY, Developed by SRIHARISH M.
                </div>
            </div>
        </div>
    </div>
